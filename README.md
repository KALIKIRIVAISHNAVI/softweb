...
<body>
    ...
    <footer>
        <center>DESIGNED AND DEVELOPED BY KALIKIRI VAISHNAVI - 212223040081  </center>
...
<html>
    <head>
        <body style= "background-image: url(bjimg.jpg)" align="center"></body>
        <meta name="viewport" content="width=device-width, initial-scale=1.0">
        <title> Contact </title>
        <style type="text/css">
            *  {
...
<body>
    <div class="banner">
        ...
        <div class="box">
            ...
            <div class="box-2"> 
                <h2> Contact Info </h2>
                <p> <span>Address :</span> 23-422 ,KT ROAD,TIRUPATI </p>
                <p> <span>Email :</span>  vaishnavikalikiri@gmailcom </p>
                <p> <span>Phone :</span> 8074280103 </p>
            </div>
        </div>
    </div>
    <footer>
